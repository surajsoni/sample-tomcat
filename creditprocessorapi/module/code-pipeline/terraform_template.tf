    ...
    "resource": {
        ...
        "aws_codepipeline": {
            "pipeline": {
                ...
                "name": "creditprocessorapi-pipeline",
                ...
                "stage": [
                    ...
                    },
                    {
                        "action": {
                            "category": "Build",
                            "configuration": {
                                "ProjectName": "creditprocessorapi-cb"
                            },
                            "input_artifacts": [
                                "source"
                            ],
        ...
        "aws_iam_role": {
            "codebuild_role": {
                ...
                "name": "creditprocessorapi-cbr"
            },
            "codepipeline_role": {
                "assume_role_policy": "${file(\"./policies/codepipeline_role.json\")}",
                "name": "creditprocessorapi-cpr"
            }
        },
        "aws_iam_role_policy": {
            "codebuild_policy": {
                "name": "creditprocessorapi-cbp",
                "policy": "${data.template_file.codebuild_policy.rendered}",
                "role": "${aws_iam_role.codebuild_role.id}"
            },
            "codepipeline_policy": {
                "name": "creditprocessorapi-cpp",
        ...
        "aws_s3_bucket": {
            "source": {
                "acl": "private",
                "bucket": "creditprocessorapi-s3-bucket",
                "force_destroy": true
            }
        }
    },
